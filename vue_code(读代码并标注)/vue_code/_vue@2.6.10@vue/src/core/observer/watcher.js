...
export default class Watcher {
  ...
  /*
    这里：保证最起码执行一次this.sbus中的Watcher更新，

    如：
    this.name = 123
    this.name = 123
    由于this.subs中始终保存着上一次最后一个Watcher依赖，最初只有一个Watcher，这里this.subs的变化为 1个 => 2个 => cleanupDeps清除为1个  => 第二次改变由于值未变化在set阶段被return掉了
    如第二次值变化了，则重新执行上述过程
